...
<div class="max-w-full mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Isi data ruangan baru</p>
        </div>
    </div>

    {{-- Form with Draft --}}
    <x-form-draft formId="create-ruangan" formName="Ruangan">
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form id="create-ruangan" action="{{ route('sarana-umum.data-ruangan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
