...
<div class="max-w-full mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        <a href="{{ route('sarana-umum.kategori-sarana.index') }}" class="text-gray-500 hover:text-gray-700">
            <x-heroicon-o-arrow-left class="w-6 h-6"/>
        </a>
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Kategori Sarana</h1>
            <p class="text-gray-600 mt-1">Buat kategori sarana baru</p>
        </div>
    </div>

    {{-- Form with Draft --}}
    <x-form-draft formId="create-kategori" formName="Kategori Sarana">
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form id="create-kategori" action="{{ route('sarana-umum.kategori-sarana.store') }}" method="POST">
            @csrf
            ...
            <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t">
                <a href="{{ route('sarana-umum.kategori-sarana.index') }}" class="px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition">
                    Batal
                </a>
