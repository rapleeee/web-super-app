...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Detail Kategori Sarana</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 border-t flex items-center justify-end gap-3">
                <a href="{{ route('sarana-umum.kategori-sarana.edit', $kategoriPerangkat) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-[#272125] text-white rounded-lg hover:bg-[#3a3136] transition">
                    <x-heroicon-o-pencil-square class="w-4 h-4"/>
                    Edit
                </a>
                <form id="delete-kategori-show" action="{{ route('sarana-umum.kategori-sarana.destroy', $kategoriPerangkat) }}" method="POST">
                    @csrf
                    @method('DELETE')
