...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Kategori Sarana</h1>
            <p class="text-gray-600 mt-1">Kelola kategori sarana umum sekolah</p>
        </div>
        <a href="{{ route('sarana-umum.kategori-sarana.create') }}"
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-lg bg-[#272125] flex items-center justify-center text-white">
                                        @if($kategori->hasValidOutlineIcon())
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('sarana-umum.kategori-sarana.show', $kategori) }}" class="text-blue-600 hover:text-blue-800" title="Lihat">
                                        <x-heroicon-o-eye class="w-5 h-5"/>
                                    </a>
                                    <a href="{{ route('sarana-umum.kategori-sarana.edit', $kategori) }}" class="text-yellow-600 hover:text-yellow-800" title="Edit">
                                        <x-heroicon-o-pencil-square class="w-5 h-5"/>
                                    </a>
                                    <form id="delete-kategori-{{ $kategori->id }}" action="{{ route('sarana-umum.kategori-sarana.destroy', $kategori) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p>Belum ada data kategori sarana.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
