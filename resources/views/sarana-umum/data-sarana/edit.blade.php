...
<div class="max-w-full mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Sarana Umum</h1>
            <p class="text-gray-600 mt-1">Ubah data sarana {{ $saranaUmum->nama }}</p>
        </div>
    </div>

    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('sarana-umum.data-sarana.update', $saranaUmum) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="kode_inventaris" id="kode_inventaris" value="{{ old('kode_inventaris', $saranaUmum->kode_inventaris) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $saranaUmum->nama) }}"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="jenis" id="jenis" value="{{ old('jenis', $saranaUmum->jenis) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi', $saranaUmum->lokasi) }}"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="merk" id="merk" value="{{ old('merk', $saranaUmum->merk) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="model" id="model" value="{{ old('model', $saranaUmum->model) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_seri" id="nomor_seri" value="{{ old('nomor_seri', $saranaUmum->nomor_seri) }}"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="tahun_pengadaan" id="tahun_pengadaan" value="{{ old('tahun_pengadaan', $saranaUmum->tahun_pengadaan) }}" min="2000" max="2100"
                    ...
                    <div>
                        ...
                        <select name="kondisi" id="kondisi"
                            ...
                            <option value="baik" {{ old('kondisi', $saranaUmum->kondisi) === 'baik' ? 'selected' : '' }}>Baik</option>
                            <option value="rusak_ringan" {{ old('kondisi', $saranaUmum->kondisi) === 'rusak_ringan' ? 'selected' : '' }}>Rusak Ringan</option>
                            <option value="rusak_berat" {{ old('kondisi', $saranaUmum->kondisi) === 'rusak_berat' ? 'selected' : '' }}>Rusak Berat</option>
                            <option value="mati_total" {{ old('kondisi', $saranaUmum->kondisi) === 'mati_total' ? 'selected' : '' }}>Mati Total</option>
                        </select>
                        @error('kondisi')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="aktif" {{ old('status', $saranaUmum->status) === 'aktif' ? 'selected' : '' }}>Aktif</option>
                            <option value="dalam_perbaikan" {{ old('status', $saranaUmum->status) === 'dalam_perbaikan' ? 'selected' : '' }}>Dalam Perbaikan</option>
                            <option value="tidak_aktif" {{ old('status', $saranaUmum->status) === 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                        @error('status')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <textarea name="keterangan" id="keterangan" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#272125] focus:border-transparent @error('keterangan') border-red-500 @enderror">{{ old('keterangan', $saranaUmum->keterangan) }}</textarea>
                    @error('keterangan')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    @if ($saranaUmum->foto)
                        <div class="mb-3">
                            <img src="{{ Storage::url($saranaUmum->foto) }}" alt="Foto {{ $saranaUmum->nama }}" class="w-36 h-24 rounded-lg object-cover">
