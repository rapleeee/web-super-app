...
<div class="max-w-full mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Detail Petugas Sarpras</h1>
            <p class="text-gray-600 mt-1">Informasi lengkap petugas sarpras</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-4 bg-gray-50 border-t flex items-center justify-end gap-3">
            <a href="{{ route('sarana-umum.petugas-sarpras.edit', $petugas) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-[#272125] text-white rounded-lg hover:bg-[#3a3136] transition">
                <x-heroicon-o-pencil-square class="w-4 h-4"/>
                Edit
            </a>
            <form id="delete-petugas-show" action="{{ route('sarana-umum.petugas-sarpras.destroy', $petugas) }}" method="POST">
                @csrf
                @method('DELETE')
