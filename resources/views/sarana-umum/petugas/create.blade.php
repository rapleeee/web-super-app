...
<div class="max-w-full mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Petugas Sarpras</h1>
            <p class="text-gray-600 mt-1">Isi data petugas sarpras baru</p>
        </div>
    </div>

    {{-- Form with Draft --}}
    <x-form-draft formId="create-petugas" formName="Petugas Sarpras">
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form id="create-petugas" action="{{ route('sarana-umum.petugas-sarpras.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
