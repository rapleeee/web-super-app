...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Data Petugas Sarpras</h1>
            <p class="text-gray-600 mt-1">Kelola data petugas sarpras</p>
        </div>
        <a href="{{ route('sarana-umum.petugas-sarpras.create') }}"
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('sarana-umum.petugas-sarpras.show', $petugas) }}" class="text-blue-600 hover:text-blue-800" title="Lihat">
                                        <x-heroicon-o-eye class="w-5 h-5"/>
                                    </a>
                                    <a href="{{ route('sarana-umum.petugas-sarpras.edit', $petugas) }}" class="text-yellow-600 hover:text-yellow-800" title="Edit">
                                        <x-heroicon-o-pencil-square class="w-5 h-5"/>
                                    </a>
                                    <form id="delete-petugas-{{ $petugas->id }}" action="{{ route('sarana-umum.petugas-sarpras.destroy', $petugas) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p>Belum ada data petugas sarpras.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
