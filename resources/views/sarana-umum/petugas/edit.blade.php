...
<div class="max-w-full mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        <a href="{{ route('sarana-umum.petugas-sarpras.index') }}" class="text-gray-500 hover:text-gray-700">
            <x-heroicon-o-arrow-left class="w-6 h-6"/>
        </a>
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Petugas Sarpras</h1>
            <p class="text-gray-600 mt-1">Perbarui data petugas sarpras</p>
        </div>
    </div>

    {{-- Form --}}
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('sarana-umum.petugas-sarpras.update', $petugas) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="nip" id="nip" value="{{ old('nip', $petugas->nip) }}"
            ...
            <div>
                ...
                <input type="text" name="no_telepon" id="no_telepon" value="{{ old('no_telepon', $petugas->no_telepon) }}"
            ...
            <div>
                ...
                @if ($petugas->foto)
                    <div class="mb-3">
                        <img src="{{ Storage::url($petugas->foto) }}" alt="{{ $petugas->nama }}" class="w-20 h-20 rounded-lg object-cover">
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t">
                <a href="{{ route('sarana-umum.petugas-sarpras.index') }}" class="px-4 py-2 text-gray-700 hover:text-gray-900">
                    Batal
                </a>
