...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        <a href="{{ route('sarana-umum.data-guru.index') }}" class="text-gray-500 hover:text-gray-700">
            <x-heroicon-o-arrow-left class="w-6 h-6"/>
        </a>
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Guru</h1>
            <p class="text-gray-600 mt-1">Tambah data guru baru</p>
        </div>
    </div>

    {{-- Form --}}
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('sarana-umum.data-guru.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100">
                <a href="{{ route('sarana-umum.data-guru.index') }}" class="px-4 py-2 text-gray-700 hover:text-gray-900">
                    Batal
                </a>
